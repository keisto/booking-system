    ...
    <div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-8 mt-6">
            @foreach($employees as $employee)
                <a href="{{ route('employee.show', $employee) }}" class="py-8 px-6 bg-gray-900 border border-gray-800 hover:bg-gray-800 shadow-lg rounded-lg flex flex-col items-center justify-center">
